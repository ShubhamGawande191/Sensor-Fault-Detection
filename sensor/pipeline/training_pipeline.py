...
class TrainPipeline:
    ...
    def start_data_valildation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        try:
    ...
    def start_model_transformation(self, data_validation_artifact: DataValidationArtifact):
        try:
            data_transformation_config = DataTransformationConfig(training_pipeline_config=self.training_pipeline_config)
            data_transformation = DataTransformation(data_validation_artifact=data_validation_artifact, data_transformation_config=data_transformation_config)
            data_transformation_artificat = data_transformation.initiate_data_transformation()
    ...
    def run_pipeline(self):
        try:
            ...
            data_validation_artifact = self.start_data_valildation(data_ingestion_artifact=data_ingestion_artifact)
