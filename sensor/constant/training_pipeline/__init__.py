...
MODEL_OBJECT_FILE_NAME = "model.pkl"
...
# Data Tramformation related constant start with DATA_TRANSFORMATION VAR NAME
...
MODEL_EVALUATOR_REPORT_NAME: str = "report.yaml"
